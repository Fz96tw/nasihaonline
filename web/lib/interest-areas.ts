...
export const INTEREST_AREA_LABELS: Record<InterestArea, string> = {
  ...
  [InterestArea.health_fitness]: "Health & Fitness",
  [InterestArea.engineering]: "Engineering",
  [InterestArea.psychology_sociology]: "Psychology & Sociology",
  [InterestArea.career_development]: "Career Development",
  [InterestArea.law]: "Law",
  [InterestArea.philosophy]: "Philosophy",
  [InterestArea.diy]: "DIY",
  [InterestArea.home_improvement_decor]: "Home Improvement & Decor",
  [InterestArea.architecture]: "Architecture",
  [InterestArea.photography]: "Photography",
  [InterestArea.camping_hiking]: "Camping & Hiking",
  [InterestArea.fishing]: "Fishing",
  [InterestArea.nature_wildlife]: "Nature & Wildlife",
};
