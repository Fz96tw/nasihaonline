...
// Forums/Blogs/Library ship in later phases (PRD §10, Phases 4-5) — listed
// here per ui-system.md's Member Navigation spec so the IA is visible
// early, but disabled until their routes exist.
