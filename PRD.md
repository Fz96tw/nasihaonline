...
- [ ] A member can browse and post in Discussion Forums (all seeded categories); posts are visible to the full membership, and a member can follow a forum to receive digest updates instead of per-post notifications.
