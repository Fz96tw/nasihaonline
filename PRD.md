...
- [ ] A member can browse and post in Discussion Forums (all seeded categories); posts are visible to the full membership, and reply notifications reach only a thread's participants and any `@`-tagged member — not the whole forum — so no separate per-forum follow/digest mechanism is needed.
