...
Two more forums are seeded alongside these six — **Events Discussion** (§4.6) and **Library Discussions** (§4.9) — but don't appear in the `/forums` category index: see the norms below for why.
