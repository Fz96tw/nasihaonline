...
- **Auto-posted (no human confirmation step, because the system already has ground truth):**
  ...
  - An **accepted meeting request** (§4.7, Inbox) → auto-spend for the requester at acceptance time (e.g., Expert Consultation, 1.0 hr). No symmetric auto-earn is defined for the recipient (the member who actually gives their time) — see §11's open question on this.
