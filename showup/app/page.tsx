...
export default function HomePage() {
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col gap-10 px-4 py-10 sm:py-14">
      <header className="flex flex-col items-center gap-4 text-center sm:flex-row sm:items-center sm:justify-center sm:gap-6 sm:text-left">
        {/* On wider screens the mark is as tall as the three text lines (100px), so it sits flush with the title and the last line. */}
        <Logo className="h-20 w-auto sm:h-[6.25rem]" />
        <div className="flex flex-col gap-1.5">
          ...
          <p className="text-sm text-muted-foreground">Share your screen with anyone using just a code. Free, no account needed.</p>
        </div>
      </header>
