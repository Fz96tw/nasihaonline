    ...
    return (
      <div className={wrapperClass} aria-hidden={hidden} {...inert}>
        <button
          ...
          id={`card-${mode}`}
          onClick={onSelect}
          className="flex h-full w-full items-center justify-center rounded-xl border border-border bg-muted/40 p-8 font-heading text-2xl font-semibold hover:border-primary hover:bg-muted md:min-w-[12rem]"
        >
          {card.title}
        </button>
      </div>
